...
<style>
    ...
    background-image: -webkit-linear-gradient(
        45deg,
        rgba(255, 255, 255, 0.801) 25%,
        transparent 25%,
        transparent 50%,
        rgba(255, 255, 255, 0.829) 50%,
        rgba(255, 255, 255, 0.637) 75%,
        transparent 75%,
        transparent
    );
    }
    ...
    */
    ...
    .page-home .overlay {
    background-color: rgba(14, 17, 24, 0.205)97);
    }
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                <div class="page-title  home text-center">
                                  <span class="heading-page">JNANATE WOOD GESTION COMMERCIALE
                                  </span>
                                ...
                                <div class="hexagon-menu clear">
                                    <div class="hexagon-item">
                                        ...
                                        <a  class="hex-content" href="{{route('login')}}">
